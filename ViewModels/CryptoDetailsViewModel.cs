...
namespace CryptoInfo.ViewModels
{
  public class CryptoDetailsViewModel : BaseViewModel
  {
    ...
    public CryptoDetailsViewModel(ConnectToApiService service, CandlestickChartUserControl chartUserControl)
    {
      _apiService = service;
    ...
    public async Task LoadCryptoData(string cryptoName)
    {
      try
      {
        ...
        string json = await _apiService.LoadDataFromApi(uri, "CoinGecko");
